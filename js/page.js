;(function (window) {
    ...
    var onEndAnimation = function ($elem, callback) {
        ...
        if (support.animations) {
            $elem.addEventListener(animEndEventName, onEndCallbackFn);
        } else {
            onEndCallbackFn();
        }
    };
    ...
    Revealer.prototype._addLayers = function() {
        ...
        classie.add($body, this.options.effect);
        var  strHTML = '';
        ...
        $body.appendChild(this.revealerWrapper);
    };
    ...
    Revealer.prototype.destroy = function() {
        classie.remove($body, this.options.effect);
        window.removeEventListener('resize', this.debounceResize);
        $body.removeChild(this.revealerWrapper);
    };
